...
public class ServiceRequestHomeController {
    ...
    private void handleButtonPushed(ActionEvent actionEvent) throws IOException {
        ...
        if(buttonPushed == floralDelivery)
        {
            ...
            root = FXMLLoader.load(getClass().getResource("/edu/wpi/fuchsiafalcons/fxml/FloralDeliveryServiceRequestView.fxml"));
            ...
            stage = (Stage) buttonPushed.getScene().getWindow();
            root = FXMLLoader.load(getClass().getResource("/edu/wpi/fuchsiafalcons/fxml/LanguageInterpretationServiceRequestView.fxml"));
            Scene scene = new Scene(root);
            stage.setScene(scene);  //Changing the stage
